class BaiViet {
    ...
    noiDung;
    TacGia
    constructor(tieuDe, ngayDangBai, diaPhuong, hinhAnh, noiDung, TacGia) {
        this.tieuDe = tieuDe;
...
dongHa.diaPhuong = 'thành phố Đông Hà - tỉnh Quảng trị';
...
trieuPhong.noiDung = `<p>Mưa lớn kéo dài gây lũ lụt đã ảnh hưởng nghiêm trọng đến đời sống người dân Triệu Phong, hàng trăm hecta nuôithuỷ hải sản,toàn bộ gia cầm, gia súc bị lũ cuốn trôi
        ...
        Theo thống kê hiện nay trên địa bàn huyện Triệu Phong hư hại nhiều công trình, hạ tầng, thiệt hại về hoa màu mọt số
        mô hình chăn nuôi đã bị ảnh hưởng rất nặng. Các tuyến đường liên xã đã bị chia cắt, giao thông không thể qua lại
        được. đời sống sinh hoạt của người dân rất khó khăn, phương tiện đi lại duy nhất hiện nay là ghe, xuồng. Toàn huyện
        khoảng 3.600 nhà dân bị ngập sâu, khoảng 250 hộ di dời. Tại xã Triệu Hòa có 1 người dân do nước lũ cuốn trôi chiều
        cùng ngày lực lượng chức năng đã tìm thấy thi thể giao cho gia đình. Riêng tại xã Triệu Phước có khoảng 38 h diện
        tích nuôi tôm của người dân chưa thu hoạch đã bị nước cuốn trôi.
        </p>
        `
...
gioLinh.hinhAnh = "https://image.plo.vn/w800/Uploaded/2020/cqjwqcdwp/2020_10_20/14-lu-lut-2_rcvx.jpg"
...
camLo.hinhAnh = 'https://lh3.googleusercontent.com/proxy/4uE3060yoIlH_qT5G2UdnK5QDYV06JRIh7YY4IxX0tRiZ3evwILgNxjw9ia8JxaVsY7FIjYXjbNn_28C5b82rwCz1CRPIKlbo1LiYUdIIRiqF3JlC9dl;'
    ...
    for (let i in danhSachBaiViet) {
        ...
        noiDungCon += 
                    `<div class="noi_dung_con">
                        ...
                        <div class="hinhanh">
                            <img src="${tieuDeNoiDung.hinhAnh} " alt="" width="170" height="110">
                        </div>
                        <div class="noidung">
                            <h4><a href="./tintuc.html?tin=${i}">${tieuDeNoiDung.tieuDe}</a></h4>
                        </div>
